    ...
    >
      ...
      <div className="flex flex-col gap-1.5">
        ...
        <input
          ...
          disabled={uploading}
          className="rounded-md border border-zinc-300 bg-white px-3 py-2 text-sm text-zinc-900 file:mr-3 file:rounded-md file:border-0 file:bg-zinc-100 file:px-3 file:py-1.5 file:text-sm file:font-medium file:text-zinc-700 hover:file:bg-zinc-200 disabled:cursor-not-allowed disabled:opacity-60"
        />
        {fileName && (
